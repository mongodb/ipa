...
<Guideline id="IPA-111-must-annotate-legacy-server-default" given="schema" enforcement="review" effort="reason" dependsOn={["IPA-131-must-use-x-xgen-prefix", "IPA-111-must-return-client-provided-optional-value"]}>
