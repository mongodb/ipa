...
- APIs **should** provide an update method for resources unless it is not
  ...
  - [Read-only resources](0101.md#read-only-resources) **must not** have an Update method
  - [Read-only singleton resources](0113.md#read-only-singleton-resources) **must not** have an Update method
