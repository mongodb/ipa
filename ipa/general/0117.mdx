...
<Guideline id="IPA-117-must-use-format-password-on-secrets" given="schema" enforcement="review" effort="check" dependsOn={["IPA-111"]}>
...
<Guideline id="IPA-117-must-not-format-password-on-redacted" given="schema" enforcement="review" effort="check" dependsOn={["IPA-111"]}>
