...
`<Workflow>` renders the manual evaluation steps of a guideline as a review
checklist inside a collapsible accordion. Checked steps are muted; progress is
page-local only and can be cleared with Reset.
