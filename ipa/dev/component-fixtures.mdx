...
### Inside a lintable guideline (reference only)

When the parent guideline is lintable, the workflow renders a "Reference only —
agent skips" marker: the steps document what Spectral checks.
